...
type RabbitLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.Rabbit, err error)
...
// List lists all Rabbits in the indexer.
func (s *rabbitLister) List(selector labels.Selector) (ret []*v1alpha1.Rabbit, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Rabbit))
	})
	return ret, err
}
...
type RabbitNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.Rabbit, error)
...
// List lists all Rabbits in the indexer for a given namespace.
func (s rabbitNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Rabbit, err error) {
...
// Get retrieves the Rabbit from the indexer for a given namespace and name.
func (s rabbitNamespaceLister) Get(name string) (*v1alpha1.Rabbit, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("rabbit"), name)
	}
	return obj.(*v1alpha1.Rabbit), nil
}
